...
%I = imrotate(I, 270);
figure
imshow(imrotate(I, 270));
I1 = undistortImage(I,cameraParams);
figure
imshow(imrotate(I1, 270))
...
I = imresize(I,[1280 960]);
I = undistortImage(I,cameraParams);

% Initialize features for I(1)
grayImage = rgb2gray(I);
[y,x,m] = harris(grayImage,'tile',[2 2]);
...
for n = 2:numImages
    ...
    tforms(n) = estimateGeometricTransform(matchedPoints, matchedPointsPrev,...
        'projective', 'Confidence', 10.9, 'MaxNumTrials', 2000);
...
figure
imshow(imrotate(panorama,0))%, 270))